...
class LyricsList extends StatelessWidget {
  ...
  void _openSong(
      ...
      String songTitle,
      List<dynamic> lyricsHan,
      List<dynamic> lyricsRom,
      List<dynamic> lyricsEng) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Widget _buildRowSong(
    ...
    return InkWell(
      onTap: () =>
          _openSong(context, songTitle, lyricsHan, lyricsRom, lyricsEng),
      child: ListTile(
          leading: ClipRRect(
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: lyrics[albumIndex]['songs'].length,
